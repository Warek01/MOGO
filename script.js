...
!function slider2() {
   ...
   let comments = $(".comment-section-wrapper-2 ul.comments"); // comments slider
   let offset = -1140;

   // Slide width: 1140px
   $(".comment-section-wrapper-2 img.arrow-right").click(function (e) {
      if (offset > -1140 * 4) {
   ...
   $(".comment-section-wrapper-2 img.arrow-left").click(function (e) {
